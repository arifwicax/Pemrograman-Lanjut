...
if (!empty($_POST)) {
    ...
    echo $_POST['nama_inventaris']. "<br>";

  if (isset ($_POST['jumlah_inventaris'])) {
    echo $_POST['jumlah_inventaris']. "<br>";
  }
  if (isset ($_POST['biaya_inventaris'])) {
    echo $_POST['biaya_inventaris']. "<br>";
  }
}
?>
<!doctype html>
